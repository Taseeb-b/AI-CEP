...
# Example: GROQ_API_KEY = "gsk_abc123yourkeyhere"
# ==========================================================================================
GROQ_API_KEY = "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"
...
# --- API key: hardcoded above (GROQ_API_KEY), no longer entered by the user ---
api_key = GROQ_API_KEY

if not api_key or not api_key.strip():
    st.error(
        "⚠️ No Groq API key is set. Open app.py, find the line "
        '`GROQ_API_KEY = ""` near the top of the file, and paste your key between '
        "the quotes (e.g. `GROQ_API_KEY = \"gsk_abc123...\"`). Then redeploy."
    )
    st.stop()
